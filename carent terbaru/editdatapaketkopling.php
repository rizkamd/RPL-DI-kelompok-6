...
if (isset($_POST["tambah"]))
{
    ...
    $paket->insertPaketKopling();
    header("Location: editdatapaketkopling.php");
}
        ...
        <div class="bgdiv-truck">
            ...
            <div class="row h-100" id="menulol" style="width:99vw;min-height:100vh;">
                <div class="col-2 bg-lightblue p-0 pt-5 pb-5">
                    <?php
                        $editdatapaketkopling = "font-weight-bold";
                ...
                <div class="col">
                    ...
                    <h3 class="mt-4 mb-4">Paket Kopling</h3>
                    <button type="button" class="btn btn-primary mb-3" data-toggle="modal" data-target=".bd-example-modal-lg">Tambah Paket Kopling</button>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Tambah Paket Kopling</h5>
