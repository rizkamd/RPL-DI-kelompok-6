        ...
        <div class="bgdiv-truck" style="height:100vh;">
            ...
            <div class="row h-100" id="menulol" style="width:99vw;">
                <div class="col-2 bg-lightblue p-0 pt-5 pb-5">
                    <?php
                        $lihatdatarental = "font-weight-bold";
                        require "adminmenu.php";
                    ?>
                </div>
            
                <div class="col">
                    <h3 class="mt-4 mb-4">Data Rental</h3>
                    <table class="table table-bordered bg-white">
                        ...
                        <?php
                            ...
                            while ($d = $res->fetch_assoc())
                            {
                                ...
                                {
                                    case StatusRental::$menunggu_bukti_pembayaran:
                                        $status = "Menunggu bukti pembayaran";
                                        break;
                                    case StatusRental::$menunggu_bukti_pembayaran_diterima:
                                        $status = "Menunggu bukti pembayaran diterima oleh admin";
                                        break;
                                    case StatusRental::$bukti_pembayaran_diterima:
                                        $status = "Pembayaran diterima";
                                        break;
                                    case StatusRental::$bukti_pembayaran_ditolak:
